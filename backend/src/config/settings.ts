...
const settingsSchema = z.object({
  ...
  corsAllowHeaders: z
    .string()
    .default(
      'Content-Type,Authorization,Accept,Accept-Encoding,Accept-Language,Cache-Control,User-Agent,X-Requested-With,X-Client-Platform,X-Device-ID,X-Device-Name,X-Mcp-Target-Url,X-Mcp-Authorization,Mcp-Session-Id,Mcp-Protocol-Version',
    ),
